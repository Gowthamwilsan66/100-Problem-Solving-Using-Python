...
Original file is located at
    https://colab.research.google.com/gist/Gowthamwilsan66/008fe6bb213d6fdb33f6e79afb8914ee/100daysofcode.ipynb
...
#using Function
def Gowthamwilsan(value):
  if value==0:
    return 1
  return value*Gowthamwilsan (value-1)
print(Gowthamwilsan (8))
...
```
The original string is : Gowtham Wilsan  is best and bright for programmers
The grouped dictionary is : {'Tr': {'ecGowtham'}, 'is': {''}, 'bt': {'es', 'righ'}, 'ad': {'n'}, 'fr': {'o'}, 'ps': {'rogrammer'}}
```
...
```
Input : {"Gowtham":20,"is":20,"Wilsan":10,"Python":12,"coding":15}

Output : {"Wilsan":20,"Python":10,"Youtube":12,"coding":15}
```


"""

d= {"Gowtham":20,"is":20,"Wilsan":10,"Python":12,"coding":15}
...
```
Input : str1 = ‘Gowtham’, str2 = ‘Wilsan’
Output : Yes
...
```
Input : Gowtham12 Wil11san i3s Bes1t progr88amming Pytho5n cod6er i3n tamilnadu or w3orld

Output : Gowtham 12 Wilsan i3s Bes1t progr88amming Pytho5n cod6er i3n w3orld
...
s="Gowtham12 Wil11san i3s Bes1t progr88amming Pytho5n cod6er i3n tamilnadu or w3orld"
...
```
Input : test_dict = {'Gowtham' : 50, 'Wilsan' : 50, 'Python' : 7}
        
        key_list =['Gowtham', 'Wilsan']
...
test_dict = {'Gowtham' : 50, 'Wilsan' : 50, 'python' : 7}
 
key_list =['Gowtam', 'Wilsan']
ans=0
for key in key_list:
  if key in test_dict:
    ans+=test_dict[key]
...
```
Input  : {'Gowtham: 1, 'Python': 2, 'coding':3 }
          key ="python"
...
```
Input : {‘tech’ : [“Gow3tham is prefix”, “Wilsan i7s suffix”], ‘coder’ : [“py5thon Pro7gramming ”, “Tamil la0nguage”]}


Output : {‘tech’ : [“Gowtham is prefix”, “Wilsan is suffix”], ‘coder’ : [“python programming ”, “Tamil language”]}
```
...
import re
d={"tech" : ["Gow3tham is prefix", "Wilsan i7s suffix"], "coder" : ["cod7er py5thon ", "Tamil la0nguage"]}
...
**Please write a program to print the running time of execution of "Gowtham Wilsan " for 100 times**
"""

from timeit import Timer

t=Timer("for i in range(100): 'Gowtham Wilsan '")
...
```
Input : Gowtham Wilsan Tamil Python Coder

        T

Output : 1Gowtham  Wilsan is 2amil programming py3hon coder
```


"""

s="Gowtham Wilsan Computer Science And Engineering "
res=""
t="T"
count=0
for i in s:
